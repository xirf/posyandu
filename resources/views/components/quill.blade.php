@pushOnce('style')
    ...
    <style>
        ...
        .ql-editor:focus {
            border-radius: 0.5rem;
            @apply shadow-md  shadow-cyan-600
        }
...
<div 
    ...
    <div class="relative {{ $errors->has($name) ? 'ql-editor-haserror' : '' }}">
        ...
        <div x-ref="quillEditor" x-model="content" class="bg-white min-h-full h-auto focus-visible:outline-none focus:outline-cyan-600">
            {!! old($name, $value ?? '') !!}
        </div>
