<x-home-layout>
        ...
        <div class="flex flex-col gap-4 max-w-3xl">
            ...
            <div class="flex items-center gap-4 border-b pb-4">
                ...
                @foreach ($news->tags as $tag)
                    <a href="{{ $tag->slug }}"
                        class="bg-cyan-500/20 text-cyan-700 px-2 py-1 rounded-md text-xs">{{ $tag->name }}</a>
                @endforeach
            </div>
            <div>
    ...
    <div class="pt-8 mt-8 border-t flex flex-col gap-4 max-w-7xl mx-auto">
        ...
        <div class="flex items-center justify-start gap-4 flex-col">
            @foreach ($recomedations as $item)
                <div class="bg-white shadow-cyan-200 rounded-xl overflow-hidden border border-gray-100 relative z-10"
                    ...
                    <a href="{{ route('news.show', $item['slug']) }}" class="w-full flex">
                        ...
                        <div class="w-96 shrink-0 h-auto aspect-video flex items-center justify-center relative bg-white object-cover">
