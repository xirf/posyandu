        ...
        <div class="flex items-center justify-start gap-4 flex-col">
            @foreach ($recomedations as $item)
                <div class="bg-white shadow-cyan-200 rounded-xl overflow-hidden border border-gray-100 relative z-10"
                    ...
                    <a href="{{ route('news.show', $item['slug']) }}" class="w-full flex flex-col-reverse md:flex-row">
                        ...
                        <div class="w-full md:w-56 lg:w-96 shrink-0 h-auto aspect-video flex items-center justify-center relative bg-white object-cover">
